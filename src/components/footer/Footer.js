  ...
  <div className="container">
    <div className="row">
      <div className="col-sm-6 col-lg-3 p-b-50">
        ...
        <ul>
          <li className="p-b-10">
            <a href="assets/#" className="stext-107 cl7 hov-cl1 trans-04">
              Women
            </a>
          </li>
          <li className="p-b-10">
      ...
      <div className="col-sm-6 col-lg-3 p-b-50">
        ...
        <div className="p-t-27">
          <a href="assets/#" className="fs-18 cl7 hov-cl1 trans-04 m-r-16">
    ...
    <div className="p-t-40">
      <div className="flex-c-m flex-w p-b-18">
        <a href="assets/#" className="m-all-1">
      ...
      <p className="stext-107 cl6 txt-center">
        ...
        Copyright © All rights reserved | Made with <i className="fa fa-heart-o" aria-hidden="true" /> by <a href="assets/https://colorlib.com" target="_blank">Colorlib</a> &amp; distributed by <a href="assets/https://themewagon.com" target="_blank">ThemeWagon</a>
        {/* Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. */}
      </p>
    </div>
  </div>
